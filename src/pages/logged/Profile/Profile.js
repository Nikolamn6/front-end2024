  ...
  return (
    ...
    <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="relative z-20 h-35 md:h-65">
        ...
        />
        <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4" onClick={redirectUpdate}>
          <label
            htmlFor="cover"
          ...
          >
            <input type="button"className="sr-only" />
            <span>
      ...
      <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
        <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
          <div className="relative drop-shadow-2">
            <img src={apiData?.profile || avatar} alt="profile" />
            {/* <label
              htmlFor="profile"
        ...
        <div className="mt-4">
          ...
          <p className="font-medium">{apiData?.job || ""}</p>
          ...
          <div className="mx-auto max-w-180">
            ...
            <p className="mt-4.5">
              Потребителско име: {apiData?.username}
            </p>
            <p className="mt-4.5">
              Email: {apiData?.email}
            </p>
            <p className="mt-4.5">
              Имена: {apiData?.firstName}{" "}{apiData?.lastName}
            </p>
          </div>
